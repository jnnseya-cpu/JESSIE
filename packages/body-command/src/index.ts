 ...
 *
 * This package is deliberately NOT imported by @jessie-os/shared, the
 * backend or the frontend. JESSIE-OS Ethical Gamification Charter rule C6
 ...
 * resolution of that conflict. Wiring them into JESSIE-OS is not.
 *
