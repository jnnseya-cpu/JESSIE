...
- **Voice:** MOVA is warm, brief, never patronising, never shaming, never references weight or
...
DELIVER     Timing bandit chooses the moment · channel by tier ·
            MOVA voice calibrated to age band
   ↓
...
freely, never inferred from behaviour. It governs UI density, copy register, MOVA's voice,
...
MOVA offers a star jump or a discreet ankle circle. **This is the single most defensible
