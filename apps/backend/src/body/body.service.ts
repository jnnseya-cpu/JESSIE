  ...
  private childActions() {
    return {
      anchor: this.action(
        ...
        2,
        null,
        'Short, and a good one to start the day with.',
      ),
      food: this.action(
  ...
  private adultActions(pathway: BodyPathway) {
    ...
    return {
      anchor: this.action(
        ...
        10,
        null,
        'A short walk after a meal is the easiest movement to keep, for most people.',
      ),
      food: this.action(
        ...
        0,
        null,
        'Drinks are usually the change that costs least effort for the most benefit.',
      ),
      movement: this.action(
        ...
        6,
        null,
        'Several short breaks beat one long session for breaking up sitting.',
      ),
      strength: this.action(
        strengthLed
      ...
      recovery: this.action(
        ...
        0,
        null,
        'Sleep affects appetite the next day, so the wind-down is part of the plan.',
      ),
      powerUp: this.action(
